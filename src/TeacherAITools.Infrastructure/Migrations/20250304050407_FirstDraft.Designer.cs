...
namespace TeacherAITools.Infrastructure.Migrations
{
    ...
    [Migration("20250304050407_FirstDraft")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.TeachingTool", b =>
                {
                    b.Property<int>("TeachingToolId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("TeachingToolId"));
                    ...
                    b.HasKey("TeachingToolId");

                    b.ToTable("TeachingTool", (string)null);
                });
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Lesson", b =>
                {
                    ...
                    b.HasOne("TeacherAITools.Domain.Entities.TeachingTool", "TeachingTool")
                        .WithMany("Lessons")
                        .HasForeignKey("TeachingToolId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
