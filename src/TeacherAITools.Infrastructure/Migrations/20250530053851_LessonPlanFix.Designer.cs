...
namespace TeacherAITools.Infrastructure.Migrations
{
    ...
    [Migration("20250530053851_LessonPlanFix")]
    partial class LessonPlanFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Apply", b =>
                {
                    b.Property<int>("ApplyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ApplyId"));
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.KnowLedge", b =>
                {
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Lesson", b =>
                {
                    ...
                    b.Property<string>("GeneralCapacity")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Practice", b =>
                {
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.StartUp", b =>
                {
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Apply", b =>
                {
                    b.HasOne("TeacherAITools.Domain.Entities.Lesson", "Lesson")
                        .WithOne("Apply")
                        .HasForeignKey("TeacherAITools.Domain.Entities.Apply", "LessonId");

                    b.HasOne("TeacherAITools.Domain.Entities.Prompt", "Prompt")
                        .WithOne("Apply")
                        .HasForeignKey("TeacherAITools.Domain.Entities.Apply", "PromptId");
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.KnowLedge", b =>
                {
                    b.HasOne("TeacherAITools.Domain.Entities.Lesson", "Lesson")
                        .WithOne("KnowLedge")
                        .HasForeignKey("TeacherAITools.Domain.Entities.KnowLedge", "LessonId");

                    b.HasOne("TeacherAITools.Domain.Entities.Prompt", "Prompt")
                        .WithOne("KnowLedge")
                        .HasForeignKey("TeacherAITools.Domain.Entities.KnowLedge", "PromptId");
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.Practice", b =>
                {
                    b.HasOne("TeacherAITools.Domain.Entities.Lesson", "Lesson")
                        .WithOne("Practice")
                        .HasForeignKey("TeacherAITools.Domain.Entities.Practice", "LessonId");

                    b.HasOne("TeacherAITools.Domain.Entities.Prompt", "Prompt")
                        .WithOne("Practice")
                        .HasForeignKey("TeacherAITools.Domain.Entities.Practice", "PromptId");
            ...
            modelBuilder.Entity("TeacherAITools.Domain.Entities.StartUp", b =>
                {
                    b.HasOne("TeacherAITools.Domain.Entities.Lesson", "Lesson")
                        .WithOne("StartUp")
                        .HasForeignKey("TeacherAITools.Domain.Entities.StartUp", "LessonId");

                    b.HasOne("TeacherAITools.Domain.Entities.Prompt", "Prompt")
                        .WithOne("StartUp")
                        .HasForeignKey("TeacherAITools.Domain.Entities.StartUp", "PromptId");
