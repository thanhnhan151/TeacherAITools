...
{
    public class GetLessonsQueryHandler : IRequestHandler<GetLessonsQuery, PaginationResponse<GetLessonResponse>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public GetLessonsQueryHandler(IUnitOfWork unitOfWork)
        {
